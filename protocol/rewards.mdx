...
│                                                                             │
│   closeEpoch(studio, epoch) triggers:                                       │
│                                                                             │
│   ┌─────────────────────────────────────────────────────────────────────┐  │
│   │  FOR EACH work submission:                                           │  │
│   │                                                                      │  │
│   │  1. Get all participants                                             │  │
│   │     participants = getWorkParticipants(dataHash)                     │  │
│   │                                                                      │  │
│   │  2. FOR EACH worker:                                                 │  │
│   │     a. Collect verifier scores                                       │  │
│   │        scores = getScoreVectorsForWorker(dataHash, worker)          │  │
│   │                                                                      │  │
│   │     b. Compute consensus                                             │  │
│   │        consensus = robustAggregate(scores)                          │  │
│   │                                                                      │  │
│   │     c. Calculate quality scalar                                      │  │
│   │        q = sum(ρ_d × c_d)                                           │  │
│   │                                                                      │  │
│   │     d. Calculate payout                                              │  │
│   │        payout = q × contrib_weight × escrow                          │  │
│   │                                                                      │  │
│   │     e. Transfer funds                                                │  │
│   │        studio.releaseFunds(worker, payout)                          │  │
│   │                                                                      │  │
│   │     f. Publish reputation                                            │  │
│   │        FOR EACH dimension d:                                         │  │
│   │          reputationRegistry.giveFeedback(                            │  │
│   │            agentId, consensus[d], dimension_tag[d]                   │  │
│   │          )                                                           │  │
│   │                                                                      │  │
│   └─────────────────────────────────────────────────────────────────────┘  │
│                                                                             │
