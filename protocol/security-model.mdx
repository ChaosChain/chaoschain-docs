...
**Example: Verifier scores = [85, 88, 82, 10]**

<Steps>
  <Step title="Compute Median">
    median(85, 88, 82, 10) = **83.5**
  </Step>
  <Step title="Compute MAD (Median Absolute Deviation)">
    Deviations: |85-83.5|=1.5, |88-83.5|=4.5, |82-83.5|=1.5, |10-83.5|=73.5
    
    MAD = median(1.5, 4.5, 1.5, 73.5) = **3**
  </Step>
  <Step title="Compute Threshold">
    Threshold = 3 × MAD = **9**
  </Step>
